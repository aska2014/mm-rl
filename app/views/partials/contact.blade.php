...
<section id="contact" class="container parallax5">
    ...
    <div class="inner contact">
        ...
        <h1 class="header semibold white"> <span class="extrabold">ابق على اتصال معنا</span></h1>



        <!-- Description -->

        <h4 class="h-desc white contact-text">يسرنا دائما استقبال رسائلكم ومقترحاتكم على صفحات التواصل الاجتماعي   </h4>
